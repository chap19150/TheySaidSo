...
/**
 * Static methods to get the edge paths of the elements in the scene
 * 
 * @author kchapman
 * 
 */
public class Edges {
	...
	public static EdgeShape[] getEdges(int edgeType) {
		switch (edgeType) {
		case GumballGameView.mCaneMainTinyId:
			return getCaneMainTinyShapes();
		case GumballGameView.mCaneMainMedId:
			return getCaneMainMedShapes();
		case GumballGameView.mCaneMainLongId:
			return getCaneMainLongShapes();
		case GumballGameView.mCaneMainSmallId:
			return getCaneMainSmallShapes();
		case GumballGameView.mCaneMainTinyReverseId:
			return getCaneMainReverseTinyShapes();
		case GumballGameView.mCaneMainMedReverseId:
			return getCaneMainReverseMedShapes();
		case GumballGameView.mCaneMainLongReverseId:
			return getCaneMainReverseLongShapes();
		case GumballGameView.mCaneMainSmallReverseId:
			return getCaneMainReverseSmallShapes();
		case GumballGameView.mCaneHookId:
			return getCaneHookShapes();
		case GumballGameView.mCaneHookReverseId:
			return getCaneHookReverseShapes();
		case GumballGameView.mCaneHookFlipId:
			return getCaneHookFlipShapes();
		case GumballGameView.mCaneHookReverseFlipId:
			return getCaneHookReverseFlipShapes();
		case GumballGameView.mCaneEndId:
			return getCaneEnd();
		case GumballGameView.mCaneEndReverseId:
			return getCaneEndReverse();
		case GumballGameView.mCaneEndFlipId:
			return getCaneEndFlip();
		case GumballGameView.mCaneEndReverseFlipId:
			return getCaneEndReverseFlip();

		case GumballGameView.mCaneMainSmallAngleNineId:
			return getCaneMainSmallAngleNineShapes();
		case GumballGameView.mCaneMainSmallAngleSixId:
			return getCaneMainSmallAngleSixShapes();
		case GumballGameView.mCaneMainSmallAngleTwelveId:
			return getCaneMainSmallAngleTwelveShapes();
		case GumballGameView.mCaneMainReverseTinyAngleSixId:
			return getCaneMainTinyAngleSixShapes();

		case GumballGameView.mCaneMainLargeAngleSixId:
			return getCaneMainLargeAngleSixShapes();
		case GumballGameView.mCaneMainMedAngleSixId:
